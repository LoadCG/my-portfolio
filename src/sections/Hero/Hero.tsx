          ...
          <p className="mt-3 text-base leading-relaxed text-gray-400 md:mt-4 md:text-lg">
            ...
            >
              <HiDownload className="mr-2 h-5 w-5" />
                ...
                <a
                href="#contact"
                className="inline-flex w-full group transform items-center justify-center rounded-full bg-green-500 px-4 py-2 text-lg font-medium text-white transition-transform hover:bg-green-600 focus:ring-2 focus:ring-green-400 focus:outline-none md:w-auto md:hover:scale-105"
                >
            ...
            <a
              ...
              className="inline-flex w-full transform items-center justify-center rounded-full bg-gray-800 px-4 py-2 text-lg font-medium text-white transition-transform hover:bg-gray-700 focus:ring-2 focus:ring-gray-600 focus:outline-none md:w-auto md:hover:scale-105"
            >
              <svg
