export default {
  ...
  about: {
    ...
    titlePart2: "About Me",
    content: `I am a <strong>professional graphic designer</strong> and an <strong>aspiring front-end developer</strong>. During the day, I study <strong>Systems Analysis and Development</strong> at Fatec São José dos Campos - Prof. Jessen Vidal, while continuing to deepen my knowledge as a self-taught developer in <strong>React and Tailwind CSS</strong> to transform creative ideas into functional interfaces. At night, I work at a design agency, where I create advertising campaigns, print materials, social media assets, and creative copy—an experience that has taught me to <strong>think strategically</strong> about every pixel and word.<br/><br/>
  ...
  projects: {
    ...
    title: "Projects",
    subtitle:
      "Browse through selected works that represent my dual expertise in building digital experiences and crafting compelling visual narratives.",
  ...
  pricing: {
    ...
    plans: {
      pricePerProject: "project",
      pricePerPackage: "package",
      ecommerce: {
        title: "E-commerce",
        ...
        features: {
          ...
          slots: "Only 2 slots/month",
        },
        tooltips: {
          catalog: "Product listing with filters and categories",
          payment: "Stripe, PayPal or local payment methods",
        },
      },
      landing: {
        title: "Landing Page",
        description: "Professional one-page website",
        price: "$199",
        features: {
          responsive: "Fully responsive design",
          sections: "5 customized sections",
          contact: "Contact form integration",
          slots: "Only 5 slots/month",
        },
      },
      brand: {
        ...
        price: "$149",
        features: {
          logo: "Main logo + variations",
          colors: "Professional color palette",
          guide: "Basic style guide",
          slots: "Only 3 slots/month",
        },
      },
    },
    button: "Choose Plan",
  ...
  contact: {
    ...
    options: {
      ...
      location: {
        title: "Location",
        text: "Caçapava-SP, Brazil",
        secondaryText: "(Open to remote work)",
        email: "Prefer email? Reach me directly at",
      },
    },
  },
  footer: {
    copyright: "© {{year}} Cauan Gabriel. All rights reserved.",
    social: {
      instagram: "Instagram",
      linkedin: "LinkedIn",
      github: "GitHub",
  ...
  skills: {
    ...
    title: "Skills",
    subtitle:
      "Technical skills (Hard Skills) build the project, behavioral skills (Soft Skills) build the bridge with people.",
    categories: {
  ...
  courses: {
    titleWhite: "Additional",
    title: "Courses",
    subtitle:
      "Extra training and certifications that support my role as a developer and designer.",
    list: {
      uiux: {
  ...
  documentTitle: "Cauan G. - Fullstack Dev. & Designer",
};
