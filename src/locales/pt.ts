export default {
  ...
  about: {
    ...
    content: `Sou <strong>designer gráfico profissional</strong> e <strong>desenvolvedor front-end em formação</strong>. Durante o dia, curso <strong>Análise e Desenvolvimento de Sistemas</strong> na Fatec São José dos Campos - Prof. Jessen Vidal, e sigo me aprofundando de forma autodidata em <strong>React e Tailwind CSS</strong> para transformar ideias criativas em interfaces funcionais. À noite, atuo em uma agência de design, onde crio campanhas publicitárias, materiais impressos, peças para redes sociais e textos criativos — vivência que me ensinou a <strong>pensar estrategicamente</strong> em cada pixel e palavra.<br/><br/>
